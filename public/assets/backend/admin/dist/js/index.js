...
$('#open').click(function() {
    toast_notification.show_toast({title: 'Error', message: 'Error Message', time: 10, type: 'error'})
})
$('#sucess').click(function() {
    toast_notification.show_toast({title: 'Success', message: 'Success Message', time: 3, type: 'success'})
})
$('#warning').click(function() {
    toast_notification.show_toast({title: 'Warning', message: 'Warning Message', time: 30, type: 'warning'})
})
