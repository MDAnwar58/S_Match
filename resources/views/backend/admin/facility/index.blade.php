            ...
            <table class="table">
              <thead>
                <tr class="fs-5" style="color: black; font-family: 'Poppins', sans-serif;">
                  <th>#</th>
                  <th>Facility Icon</th>
                  <th style="width: 15%;">Facility Title</th>
              ...
              <tbody>
               ...
               <tr>
                ...
                <td>
                  @if($facility->role == 0)
                  <a href="{{ route('facility.facilityRole', $facility->id) }}" class="btn btn-secondary">Active</a>
                  @else
                  <a href="{{ route('facility.facilityRole', $facility->id) }}" class="btn btn-warning">Inactive</a>
                  @endif
                </td>
                <td>
                 <a href="{{ route('facility.edit', $facility->id) }}" class="btn btn-primary">Edit</a>
                 <a href="javascript:void(0)" data-url="{{ route('facility.destroy', $facility->id) }}" class="btn btn-danger delete">Delete</a>
               </td>
             </tr>
             @endforeach
           </tbody>
