...
@section('content')
  ...
  <div class="container-fluid">
    ...
    <div class="d-flex flex-row comment-row">
      <div class="p-2">
        <img
        src="{{ asset('assets/backend/admin/images/users/4.jpg') }}"
        alt="user"
        width="50"
        class="rounded-circle"
        />
...
<div class="d-flex flex-row comment-row">
  <div class="p-2">
    <img
    src="{{ asset('assets/backend/admin/images/users/5.jpg') }}"
    alt="user"
    width="50"
    class="rounded-circle"
    />
    ...
    <div class="todo-widget scrollable" style="height: 450px">
      ...
      <ul class="list-style-none assignedto">
        ...
        <li class="assignee">
          ...
          class="rounded-circle"
          width="40"
          src="{{ asset('assets/backend/admin/images/users/2.jpg') }}"
          alt="user"
          data-toggle="tooltip"
          data-placement="top"
          title=""
        ...
        <li class="assignee">
          ...
          class="rounded-circle"
          width="40"
          src="{{ asset('assets/backend/admin/images/users/3.jpg') }}"
          alt="user"
          data-toggle="tooltip"
          data-placement="top"
          title=""
