            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <p class="mt-1" style="font-size: .7rem;">সকাল:</p> 
                    <p class="mt-3" style="font-size: .7rem; padding: .6rem 0 0 0;">দুপুর:</p> 
                    <p class="mt-3" style="font-size: .7rem; padding: .5rem 0 0 0;">সন্ধা:</p>
                  </td>
                  <td>
                  ...
                  <td>
                    <a href="javascript:void(0)" data-url="{{ route('admin.mile.destroy', $mile->id) }}" class="btn btn-danger delete">Clear</a>
                  </td>
                </tr>
                @endforeach
